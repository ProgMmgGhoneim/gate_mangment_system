...
class Car(BaseModel):
    ...
    plate_number  =  models.CharField(_("Plate number"), unique=True, max_length=100, null=False, blank=False, db_index=True)
    ...
    image = models.ImageField(_("Image"), null=False, blank=False, upload_to =upload_to)
